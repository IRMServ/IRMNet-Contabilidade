...
return array(
        ...
        'routes' => array(
            ...
            'contabilidade' => array(
                ...
                'options' => array(
                    'route' => '/contabilidade',
                    'defaults' => array(
                       // '__NAMESPACE__' => 'Contabilidade\Controller',
                        'controller' => 'Contabilidade\Controller\Index',
                        'action' => 'index',
                    ),
                ),
            ),
    ...
    'controllers' => array(
        'invokables' => array(
            'Contabilidade\Controller\Index' => 'Contabilidade\Controller\IndexController'
        ),
    ),
    'view_manager' => array(
